!(function(t, e) {
    ...
    (L.StyleEditor.Util = L.Class.extend({
        ...
        fireEvent: function(t, e) {
            this.options.styleEditorOptions.map.fireEvent(
                this.options.styleEditorOptions.styleEditorEventPrefix + t,
                e
            );
        },
        ...
        rgbToHex: function(t, e) {
            if (
                (t ||
                    (0 !==
                        (t = this.options.styleEditorOptions
            ...
            let o = t
                    ...
                    .split(","),
                i =
                    this._componentToHex(parseInt(o[0], 10)) +
                    this._componentToHex(parseInt(o[1], 10)) +
                    this._componentToHex(parseInt(o[2], 10));
            return e ? i : "#" + i;
        },
        ...
        setStyle: function(t) {
            ...
            for (let e = 0; e < o.length; e++) {
                ...
                if (i instanceof L.Marker)
                    ...
                    let e = {};
                    (e[this.options.styleOption] = t),
                        i.setStyle(e),
                        (i.options[this.options.styleOption] = t);
                }
    ...
    (L.StyleEditor.formElements.PopupContentElement = L.StyleEditor.formElements.FormElement.extend(
        {
            ...
            createContent: function() {
                let t = this.options.uiElement,
                    e = (this.options.descTextAreaField = L.DomUtil.create(
                        "textarea",
            ...
            _setStyle: function() {
                ...
                for (let t = 0; t < o.length; t++) {
                    ...
                    if (i && i.getPopup && i.bindPopup) {
                        let t = i.getPopup();
                        t ? t.setContent(e) : i.bindPopup(e),
                            (i.options = i.options || {}),
                            (i.options.popupContent = e);
                    }
                }
                this.setStyle(e);
            }
    ...
    (L.StyleEditor.formElements.IconElement = L.StyleEditor.formElements.FormElement.extend(
        {
            ...
            _toggleSelectInput: function(t) {
                let e = this._getCurrentColorElement(
            ...
            _hideSelectOptions: function() {
                for (let t in this.options.selectOptions)
                    this.options.styleEditorOptions.util.hideElement(
                        this.options.selectOptions[t]
                    );
            }
    ...
    (L.StyleEditor.formElements.ColorElement = L.StyleEditor.formElements.FormElement.extend(
        {
            ...
            _selectColor: function(t) {
                t.stopPropagation(),
                    ...
                    this.options.styleEditorOptions.currentElement
    ...
    (L.StyleEditor.formElements.OpacityElement = L.StyleEditor.formElements.FormElement.extend(
        {
            createContent: function() {
                ...
                let t = (this.options.slider = L.DomUtil.create(
                    "input",
                    "leaflet-styleeditor-input",
                    this.options.uiElement
                ));
            ...
            style: function() {
                (this.options.slider.value = this.options.styleEditorOptions.util.getStyle(
                    this.options.styleOption
                )),
    ...
    (L.StyleEditor.formElements.WeightElement = L.StyleEditor.formElements.FormElement.extend(
        {
            createContent: function() {
                ...
                let t = (this.options.weight = L.DomUtil.create(
                    "input",
                    "leaflet-styleeditor-input",
                    this.options.uiElement
                ));
            ...
            style: function() {
                (this.options.weight.value = this.options.styleEditorOptions.util.getStyle(
                    this.options.styleOption
                )),
    ...
    (L.StyleEditor.forms.Form = L.Class.extend({
        ...
        hideFormElements: function() {
            for (let t = 0; t < this.options.initializedElements.length; t++)
    ...
    (L.StyleEditor.forms.GeometryForm = L.StyleEditor.forms.Form.extend({
        ...
        showFormElements: function() {
            for (let t = 0; t < this.options.initializedElements.length; t++)
                0 ===
                this.options.initializedElements[t].options.styleOption.indexOf(
                    "fill"
                )
    ...
    (L.StyleEditor.marker.Marker = L.Marker.extend({
        ...
        setStyle: function(t, e) {
            "icon" !== t &&
                (t = "icon" + t.charAt(0).toUpperCase() + t.slice(1)),
        ...
        getIconOptions: function() {
            ...
            return (
                this.options.styleEditorOptions.currentElement &&
                    (t = this.options.styleEditorOptions.currentElement.target
                        .options.icon.options),
                t.iconColor || (t.iconColor = this._getDefaultMarkerColor()),
                t.iconSize ||
                    (t.iconSize = this.options.styleEditorOptions.markerType.options.size.small),
                t.icon ||
                    (t.icon = this.options.styleEditorOptions.util.getDefaultMarkerForColor(
                        t.iconColor
                    )),
                (this.options.iconOptions = this._ensureMarkerIcon(t)),
                t
            );
        },
        resetIconOptions: function() {
            Object.keys(this.getIconOptions()).forEach(t =>
                this.setStyle(t, this.options.iconOptions[t])
            );
        },
        ...
        _getDefaultMarkerColor: function() {
            ...
            return (
                ...
                null === i &&
                    (null ===
                        (i = this.options.styleEditorOptions.defaultColor) ||
                        o.includes(i) ||
                        (i = null),
                    null === i && (i = o[0])),
    ...
    (L.Control.StyleEditor = L.Control.extend({
        ...
        initialize: function(t) {
            t && L.setOptions(this, t),
                ...
                (this.getDefaultIcon = this.options.markerType._createMarkerIcon.bind(
        ...
        createUi: function() {
            let t = (this.options.controlDiv = L.DomUtil.create(
                "div",
            ...
            let e = (this.options.cancelUI = L.DomUtil.create(
                "div",
                "leaflet-control-styleeditor-cancel leaflet-styleeditor-hidden",
                t
            ));
            (e.innerHTML = this.options.strings.cancel),
                (e.title = this.options.strings.cancelTitle);
            let o = (this.options.styleEditorDiv = L.DomUtil.create(
                "div",
                "leaflet-styleeditor",
        ...
        addLeafletDrawEvents: function() {
            this.options.openOnLeafletDraw &&
                ...
                this.options.map.on(
                    ...
                    this.onLeafletDrawCreated,
                    this
                ));
        },
        onLeafletDrawCreated: function(t) {
            this.removeIndicators(),
                (this.options.currentElement = { target: t.layer });
        },
        onLayerAdd: function(t) {
            this.options.currentElement &&
                t.layer === this.options.currentElement.target &&
                (this.enable(), this.initChangeStyle({ target: t.layer }));
        },
        onRemove: function() {
            this.disable(),
            ...
            this.fireEvent("editing", e),
                e instanceof L.Marker
                    ? (this.options.markerType.resetIconOptions(),
                      this.showMarkerForm(e))
                    : this.showGeometryForm(e);
        },
